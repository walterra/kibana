...
// Fix for `EuiComboBoxObject.setSelectedOptions` destined for
// `@elastic/eui-test-helpers`; lives here until it is ported and published.
export { ComboBoxObject } from './combo_box_object';
