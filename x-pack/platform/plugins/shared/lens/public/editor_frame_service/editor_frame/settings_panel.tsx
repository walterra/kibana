...
export const SettingsPanelWrapper = (props: SettingsPanelProps) => {
  ...
  const showSettingsPanel = !isFullscreenDatasource && activeVisualization && visualization.state;
  return showSettingsPanel ? (
    <SettingsPanel {...props} activeVisualization={activeVisualization} />
  ) : null;
};
...
export function SettingsPanel(
  ...
  const { layerId, activeVisualization, framePublicAPI, toggleAccordionCb, isAccordionOpen } =
    props;
