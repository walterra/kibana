...
import { SignificantCorrelationTerm } from '../../../../common/search_strategies/correlations/types';

const PAGINATION_SIZE_OPTIONS = [5, 10, 20, 50];

export type SelectedSignificantCorrelationTerm<
  T extends SignificantCorrelationTerm
...
interface Props<T> {
  ...
  setSelectedTerm: (term: T | null) => void;
  selectedTerm?: { fieldName: string; fieldValue: string };
  onFilter?: () => void;
  columns: Array<EuiBasicTableColumn<T>>;
}

export function CorrelationsTable<T extends SignificantCorrelationTerm>({
  significantTerms,
  status,
  setSelectedTerm,
  onFilter,
